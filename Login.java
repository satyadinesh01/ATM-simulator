...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        setTitle("BANKING MANAGEMANET SYSTEM");
...
//        add(l11);
    ...
    public void actionPerformed(ActionEvent ae){
        try{        
            if(ae.getSource()==b1){
                int str3=Integer.parseInt(tf1.getText());
                int str4=Integer.parseInt(pf2.getText());
                ...
                try {
                    ...
                    ResultSet resultSet = statement.executeQuery("select * from login where id='"+str3+"' AND pass='"+str4+"'");
